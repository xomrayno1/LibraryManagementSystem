...
<div class="right_col" role="main">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_content">
									<br />
									<c:url value="/author/list/1" var="searchUrl"></c:url>
	...
	<div class="table-responsive">
		<a href='<c:url value="/author/add"></c:url>'><button class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i>Thêm</button></a>
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          <c:forEach items="${listProduct}" var="author" varStatus="i"> 
                          	<tr>
                            ...
                            <td colspan="3" class="last text-center">
                            	<input type="hidden" id="idProduct" value="${author.id}">
	                            <a href='<c:url value="/author/view/${author.id}"></c:url>' class="btn btn-primary"><i class="glyphicon glyphicon-eye-open"></i></a> 
	                            <a href='<c:url value="/author/edit/${author.id}"></c:url>' class="btn btn-warning"><i class="glyphicon glyphicon-edit"></i></a> 
		...
		<div id="deleteModal" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<c:url value="/author/delete" var="urlDelete" />
...
<script type="text/javascript">
	function gotoPage(page){
		$("#searchForm").attr('action',"<c:url value='/author/list/'/>"+page);
		$("#searchForm").submit();
	}
	...
	$(document).ready(function(){
		$('#authorlistId').parents("li").addClass('active').siblings().removeClass("active");
		$('#authorlistId').addClass('current-page').siblings().removeClass("current-page");
		$('#authorlistId').parents().show();
	});
