					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_content">
									<br />
									<c:url value="/readers/save" var="submitUrl"></c:url>
									...
									<form:hidden path="updateDate"/>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<form:input path="mssv" cssClass="form-control" readonly="${viewOnly}"/>																								<div>
													<div class="has-error">
														<form:errors  path="mssv" cssClass="help-block"/>
													</div>
												</div>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<form:input path="nameClass" cssClass="form-control" readonly="${viewOnly}"/>																								<div>
													<div class="has-error">
														<form:errors  path="nameClass" cssClass="help-block"/>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="ln_solid"></div>										
											<div class="item form-group">
												...
												<a href='<c:url value="/readers/list/1"></c:url>'><button class="btn btn-primary" type="button"><i class="glyphicon glyphicon-minus-sign"></i> Cancel</button></a>																					
												</div>
											</div>
